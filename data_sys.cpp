...
info_to_explore_sys data_sys::event_effect(std::size_t id)
{
	...
	case 1://篝火
	{
		return info_to_explore_sys(my_vector<e_action>{
			e_action(explore_action_type::EVENT_BODY, event_type::PURE_TEXT, MEANINGLESS_VALUE, 0),
				e_action(explore_action_type::SELECTION, event_type::AQUIRE_HIT_POINTS, player_data.max_hp * 0.25, 20, 1234/* 一觉过后，你感觉神清气爽 */),
				e_action(explore_action_type::SELECTION, event_type::UPGRADE_CARD_FROM_DECK, 1, 21, 1234/* 勤练带来力量 */),
	...
	case 15://山贼
	{
		info_to_explore_sys result(my_vector<e_action>{e_action(explore_action_type::EVENT_BODY, event_type::PURE_TEXT, MEANINGLESS_VALUE, 1234/* 你在森林中穿行时，一队身着斗篷，手持匕首的山贼出现在了你的面前。你熟练地拔出武器。 */),
	...
	case 16://哨所
	{
		info_to_explore_sys result(my_vector<e_action>{e_action(explore_action_type::EVENT_BODY, event_type::PURE_TEXT, MEANINGLESS_VALUE, 1234/* 日薄西山，一个皇家哨所拦住了你的去路。你熟练地拔出武器。 */),
	...
	case 17://珊瑚洞窟
	{
		info_to_explore_sys result(my_vector<e_action>{e_action(explore_action_type::EVENT_BODY, event_type::PURE_TEXT, MEANINGLESS_VALUE, 1234/* 你走进一个珊瑚洞窟，在其中等待着你的不是宝物，而是一群手持利刃的海洋生物。你熟练地拔出武器 */),
	...
	case 18://地窖
	{
		info_to_explore_sys result(my_vector<e_action>{e_action(explore_action_type::EVENT_BODY, event_type::PURE_TEXT, MEANINGLESS_VALUE, 1234/* 你走进一座破旧的图书馆，书架上的书已经腐烂，只剩一些不死生物定居在此。你熟练地拔出武器 */),
